...
"use strict";
Object.defineProperty(exports,'__esModule',{value:!0}),exports.toCamelCase=toCamelCase;var _spaces=__webpack_require__(13);function toCamelCase(a){try{return a&&'string'==typeof a?(a=(0,_spaces.toSingleSpace)(a.trim()),a.split(' ').map(function(a){return a[0].toUpperCase()+a.substr(1).toLowerCase()}).join(' ')):a}catch(a){console.error(a)}}
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:!0}),exports.toSlug=toSlug;var _spaces=__webpack_require__(13);function toSlug(a){try{return a&&'string'==typeof a?(a=(0,_spaces.toSingleSpace)(a.trim()),a.split(' ').join('-').replace(/[/.,(){}]/g,'')):a}catch(a){console.error(a)}}
