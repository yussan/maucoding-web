...
const DEFAULT_THUMB =
  "https://res.cloudinary.com/dhjkktmal/image/upload/v1529931141/oopsreview/2018/default-thumb.png"
...
export default n => {
  ...
  return {
    ...
    image: {
      ...
      600: n.image
        ? generateCustomUrl(n.image, "w_600,c_scale")
        : generateCustomUrl(DEFAULT_THUMB, "w_600,c_scale"),
      small: n.image
        ? generateCustomUrl(n.image, "w_200,c_scale")
        : generateCustomUrl(DEFAULT_THUMB, "w_200,c_scale")
    }
  }
}
